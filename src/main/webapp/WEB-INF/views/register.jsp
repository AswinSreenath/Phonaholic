  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" id="navig">Products<span class="caret"></span></a>
	...
	<li><a href="#" id="navig">Contact Us</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="#" id="navig"><i class="fa fa-user" aria-hidden="true"> <span class="sr-only">(current)</span>Register</i></a></li>      
...
<input type="text" id="secondname" class="form-control" placeholder="Second Name"><br>
<input type="email" id="emailid" class="form-control" placeholder="Email address"><br>
<input type="password" id="password" class="form-control" placeholder="Password"> 

<br>
<input type="password" id="confirmpassword" class="form-control" placeholder="Confirm Pasword">
