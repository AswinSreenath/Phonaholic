...
<title>About Us|Phonaholic</title>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li><a href="#"><font color="#1E7145">Home</font></a></li>

					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
						aria-expanded="false"><font color="#1E7145">Products</font><span
							class="caret" style="color: #1E7145"></span></a>
						<ul class="dropdown-menu">
							<li><a href="#"><font color="#1E7145">Basic Phone</font></a></li>
							<li><a href="#"><font color="#1E7145">Smart Phone</font></a></li>
							<li><a href="#"><font color="#1E7145">Tablets</font></a></li>

						</ul></li>

					<li class="active"><a href="#"><font color="#1E7145"><span
								class="sr-only">(current)</span>About</font></a></li>
					<li><a href="#"><font color="#1E7145">Contact Us</font></a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#"><i class="fa fa-user" aria-hidden="true"
							style="color: #1E7145"><font color="#1E7145">Register</font></i></a>
					<li><a href="#"><i class="fa fa-sign-in"
							aria-hidden="true" style="color: #1E7145"><font
								color="#1E7145">Login</font></i></a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<form class="navbar-form">
						...
						<button type="submit" class="btn btn-default btn-sm button"
							style="margin-top: 12px;">
							<i class="fa fa-search" aria-hidden="true" style="color: #1E7145"></i>Search
						</button>
					</form>
				</ul>
			</div>
