...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color:white;">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href='<c:url value='/'/>'><img class="img-responsive" style="max-width:175px;margin-top:-3px;" src="images\Logomakr_2A1smS.png" /></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
     <ul class="nav navbar-nav">
		...
		<li><a href='<c:url value='/contact/'/>' id="navig">Contact Us</a></li>
     </ul>
      
      
      <ul class="nav navbar-nav navbar-right">
        <li><a href='<c:url value='/register/'/>' id="navig"><i class="fa fa-user" >Register</i></a></li>      
        <li><a href='<c:url value='/login/'/>' id="navig"><i class="fa fa-sign-in" >Login</i></a></li>
      </ul>
